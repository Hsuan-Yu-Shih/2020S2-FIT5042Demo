...
public class Property implements Serializable {
    ...
    //insert annotation here to make address as embedded to Property entity and stored as part of Property
    /**
     * @Embedded on the owning side when being mapped to database.   slide p.40
     */
    @Embedded
    ...
    /**
     * one property have one contact person.
     * however, one contact person can have many properties, so it will map to this class
     */
    @ManyToOne
    ...
    /**
     * 'the tags of a property will be stored in a table called TAG' for @CollectionTable
     * 'each tag must be stored in a column VALUE in the TAG table' for @Column
     */
    @ElementCollection
