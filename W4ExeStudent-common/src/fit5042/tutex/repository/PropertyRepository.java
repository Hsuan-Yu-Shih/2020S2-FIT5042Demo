/**
 * we need to define the source package we used
 */
...
/**
 * import the specific class we will use. 
 * here I use '*' to import all classes in the package 'fit5042.tutex.repository.entities'
 */
